...
const Success = ({ products }: Props) => {
  // console.log("🚀 ~ file: success.tsx ~ line 23 ~ Success ~ products", products)
  ...
  const subtotal = products.reduce(
    ...
    0
  ); //divided by 100 to get the correct subtotal
  ...
  const ShowOrderSummary = isTabletOrMobile ? showOrder : true;
              ...
              <div className="mx-auto max-w-xl divide-y border-gray-300 px-4 py-4 lg:mx-0 lg:max-w-lg lg:px-10 lg:py-16">
                ...
                <div className="space-y-1 py-4">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <p className="font-medium">
                      <Currency quantity={subtotal * 0.02} currency="USD" />
                    </p>
                  </div>
                </div>
                <div className="flex justify-between pt-4">
                  ...
                  <p className="flex items-center gap-x-2 text-xs text-[gray]">
                    ...
                    <span className="text-xl font-medium text-black">
                      <Currency quantity={subtotal * 1.02} currency="USD" />
                    </span>
                  </p>
                </div>
              </div>
